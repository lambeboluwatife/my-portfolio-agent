...
async function main() {
  try {
    ...
    const markdownContent = fs.readFileSync(
      path.join(__dirname, "../../docs/lambeProfile.md"),
      "utf-8"
    );
    ...
    await vectorStore.deleteIndex({indexName: "lambeProfile"});
    await vectorStore.createIndex({ indexName: "lambeProfile", dimension: 1536 });
